...
const serviceOptions = [
  { value: "facility-solutions", label: "Facility Solutions" },
  { value: "recruitment", label: "Recruitment" },
  { value: "plumbing", label: "Professional Plumbing" },
        ...
        <section ref={formRef} className="py-24 bg-section-gradient">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              ...
              {/* Right - Form (wider - takes 2 columns) */}
              <div className={cn(
                  ...
                  <div className="grid sm:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <MultiSelect
                        ...
                        onChange={(selected) => setFormData(prev => ({ ...prev, services: selected }))}
