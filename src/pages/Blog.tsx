...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        {/* Hero Section */}
        <section ref={heroRef} className="pt-32 pb-20 bg-section-gradient relative overflow-hidden">
          ...
          <div className="max-w-content relative z-10">
            <div className="max-w-3xl">
              ...
              <h1 className={cn(
                ...
                Insights &
                <span className="block mt-2 text-accent">Perspectives</span>
              </h1>
              <p className={cn(
            ...
            <div className="max-w-content">
              <Link to={`/blog/${featuredPost.id}`} className="group block">
                <div className="grid lg:grid-cols-2 gap-12 items-center p-8 rounded-3xl bg-muted/30 hover:bg-muted/50 transition-colors">
                  {/* Image placeholder */}
                  <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10 relative overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-6xl font-display font-bold text-primary/10">Featured</span>
                    </div>
                  </div>
              ...
              {regularPosts.map((post, index) => (
                ...
                >
                  <article className="h-full flex flex-col">
                    {/* Image placeholder */}
                    <div className="aspect-[16/10] rounded-2xl bg-gradient-to-br from-muted to-muted/50 mb-6 relative overflow-hidden group-hover:shadow-lg transition-shadow">
